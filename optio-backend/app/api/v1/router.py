...
from app.api.v1.business_applications import router as business_applications_router
...
from app.api.v1.public.businesses import router as public_businesses_router
...
api_router.include_router(business_applications_router)
